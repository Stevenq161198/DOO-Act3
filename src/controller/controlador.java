...
public class Controlador {
  ...
  public boolean validarIdInstructor(String idInstructor) {
    return this.laSala.existeIdInstructor(idInstructor);
  }

  public boolean validarIdServicio(int idServicio) {
    return this.laSala.existeIdServicio(idServicio);
  }
}